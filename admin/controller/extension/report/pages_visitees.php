...
class ControllerExtensionReportPagesVisitees extends Controller {
	...
	public function report() {
		...
		//$data['reset'] = $this->url->link('extension/report/pages_visitees/reset', 'user_token=' . $this->session->data['user_token'] . '&page={page}', true);
		...
		//$pages_visitees_total = $this->model_extension_report_product->getTotalProductViews();
		...
		// $pagination->url = $this->url->link('report/report', 'user_token=' . $this->session->data['user_token'] . '&code=pages_visitees&page={page}', true);
