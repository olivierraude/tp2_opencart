...
$_['text_title_advanced'] 			= 'Liste avanc&eacute;e';
...
$_['button_save_upload'] 			= 'Sauvegarder ou t&eacute;el&eacute;echarger';
...
//Text
$_['text_products_sent']			= 'Les produits were sent for en traitement';
$_['text_view_on_amazon']			= 'Voir sur Amazon';
$_['text_list']						= 'Annonces';
$_['text_new']						= 'Neuf';
...
$_['text_product_not_sent'] 		= 'Product was not sent to Amazon. Raison: %s';
$_['text_not_in_catalog'] 			= "Oo, if it is not in the catalog&nbsp;&nbsp;&nbsp;";
...
$_['text_edit_heading'] 			= 'Editer les annonces';
...
$_['entry_sale_date'] 				= 'Date de venteS';
...
$_['entry_product'] 				= 'Liste pour produit';
...
$_['error_not_saved'] 				= 'La liste n&#8217;a pas &eacute;t&eacute; sauvegard&eacute;.V&eacute;rifiez que vous avez rempli tous les champs.';
$_['error_char_limit'] 				= 'Le nombre de caract&egrave;res est trop &eacute;lev&eacute;.';
$_['error_length'] 					= 'La longueur minimale est';
$_['error_upload_failed'] 			= '&Eacute;chec du t&eacute;l&eacute;chargement du produit dont le SKU est : "%s". Raison: "%s". T&eacute;l&eacute;chargement annul&eacute;.';
$_['error_load_nodes'] 				= 'Unable to load browse nodes';
$_['error_connecting'] 				= 'Il y a eu un probl&egrave;me lors de la connexion &agrave; l&#8217;API. V&eacute;rifiez vos param&egrave;tres OpenBay Pro Amazon. Si le probl&egrave;me persiste, contactez le support.';
