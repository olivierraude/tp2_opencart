...
// Help
$_['help_merchant']			= '(identifiant boutique) pour utiliser le service Klarna (fourni par Klarna).';
$_['help_secret']			= 'La cl&eacute; secr&egrave;te pour utiliser le service Klarna (fourni par Klarna).';
$_['help_total']			= 'Le montant totale que doit atteindre la commande avant que ce mode de paiement ne devienne actif.';
