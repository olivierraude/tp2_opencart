...
// Help
$_['help_merchant']			= '(Identifiant) &agrave; utiliser pour le service Klarna (fourni par Klarna).';
$_['help_secret']			= 'Secret partag&egrave; &agrave; utiliser avec le service Klarna (fourni par Klarna).';
